...
import DeleteProjectFormContainer from './delete_project_form/delete_project_form_container';
...
import DocsShowContainer from './docs_show/docs_show_container';
...
const App = () => (
  <div>
    <Switch>
      ...
      <ProtectedRoute exact path="/projects/:projectId/status" component={DeleteProjectFormContainer} />
      ...
      <ProtectedRoute exact path="/projects/:projectId/docs/:docsId" component={DocsShowContainer} />
    </Switch>
